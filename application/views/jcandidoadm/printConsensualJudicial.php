<script> print()</script>
    ...
    <p>Qual a renda média de cada cônjuge?: <?php echo $form["renda_mensal"]; ?></p>
    
    <p>Há bens a dividir? Se sim, descrever quais bens, valores médios de mercado e localização dos imóveis 
	<br /><?php echo $form["bens_dividir"]; ?>
    </p>
   ...
   <p>Se houver filhos menores, com quem ficará a guarda?<br />
   <?php echo $form["guarda_filho"] ?></p>
   
   <p>Descrever o valor de contribuição para criar e educar os filhos menores ou maiores (caso o casal deseja estipular):<br />
   <?php echo $form["contribuicao_educacao"]; ?>
   </p>
