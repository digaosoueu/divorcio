					...
					<ul class="general-info">
						...
						<li class="column column-one">
							...
							<div class="column column-medium">
								<input maxlength="2" type="tel" value="<?php echo $dia; ?>" name="dia_casamento" placeholder="00">
							</div>

							<div class="column column-medium">
								<input maxlength="2" type="tel" value="<?php echo $mes; ?>" name="mes_casamento" placeholder="00">
							</div>

							<div class="column column-medium last">
								<input maxlength="4" type="tel" value="<?php echo $ano; ?>" name="ano_casamento" placeholder="0000">
							</div>
