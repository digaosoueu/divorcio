...
//		header( "Location: /solicitar-cadastro?cad=consensualJudicial" );
//	}else{
//		$cliente_id = $CL->{'id'};
//	
...
<main role="main">
			...
			<div class="content">
				<menu itemscope itemtype="https://schema.org/BreadcrumbList">
					<ul class="main-breadcrumb">
						...
						<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
							<a itemprop="item" class="active" href="<?php $_SERVER['PHP_SELF']; ?>">formulário consensual judicial</a>
		...
		<section class="main-single container">
			...
			<div class="content">
				...
				<form class="main-form" role="form" action="" id="formJudicialCad" name="formJudicialCad" method="POST" onsubmit="return false;">
					...
					<ul>
						...
						<li class="column column-large">
                            ...
                            <div class="column column-large">
								<label>RG*</label>
								<input type="tel"  name="rg_conjuge_1" value="<?php echo $form["rg_conjuge1"]; ?>" placeholder="00.000.000-0">
							</div>
						...
						<li class="column column-large">
							...
							<label><input type="radio" value="1"<?php if($form["retorna_nome_solteiro_conjuge1"] == "1"){?> checked="checked"<?php }?> name="nome_casado_conjuge_1">Vai retornar o nome de solteiro?</label>
							<label><input type="radio" value="0"<?php if($form["retorna_nome_solteiro_conjuge1"] == "0"){?> checked="checked"<?php }?> name="nome_casado_conjuge_1">Será mantido o nome de casado?</label>
						</li>
				...
				<h3>2° Requerente (Cônjuge)</h3>
					...
					<ul>
						<li class="column column-large">
							<label>Nome Completo*</label>
							<input type="text" name="nome_conjuge_2" value="<?php echo $form["nome_conjuge2"]; ?>" placeholder="Digite seu nome...">
						</li>
						...
						<li class="column column-large">
							...
							<div class="column column-large">
								<label>RG*</label>
								<input type="tel"  name="rg_conjuge_2" value="<?php echo $form["rg_conjuge2"]; ?>" placeholder="00.000.000-0">
							</div>
						...
						<li class="column column-large">
							...
							<label><input type="radio" value="1"<?php if($form["retorna_nome_solteiro_conjuge2"] == "1"){?> checked="checked"<?php }?> name="nome_casado_conjuge_2"> Vai retornar o nome de solteiro?</label>
					...
					<ul class="general-info">
						...
						<li class="column column-one">
							...
							<div class="column column-medium">
								<input maxlength="2" type="tel" value="<?php echo date("d", strtotime($form["data_casamento"])); ?>" name="dia_casamento" placeholder="00">
							</div>

							<div class="column column-medium">
								<input maxlength="2" type="tel" value="<?php echo date("m", strtotime($form["data_casamento"])); ?>" name="mes_casamento" placeholder="00">
							</div>

							<div class="column column-medium last">
								<input maxlength="4" type="tel" value="<?php echo date("Y", strtotime($form["data_casamento"])); ?>" name="ano_casamento" placeholder="0000">
							</div>
						...
						<li class="column column-three">
							<label>Qual a renda média de cada cônjuge?</label>
							<textarea placeholder="Descreva..." name="renda_media" rows="3"><?php echo $form["renda_mensal"]; ?></textarea>
						</li>
						...
						<li class="column column-large">
							...
							<p>Se houver filhos menores, com quem ficará a guarda?</p>

							<label><input type="radio" name="guarda"<?php if($form["guarda_filho"] == "Pai"){?> checked="checked"<?php }?> value="Pai"> Pai</label>
							<label><input type="radio" name="guarda"<?php if($form["guarda_filho"] == "Mãe"){?> checked="checked"<?php }?> value="Mãe"> Mãe</label>
							<label><input type="radio" name="guarda"<?php if($form["guarda_filho"] == "Compartilhada"){?> checked="checked"<?php }?> value="Compartilhada"> Compartilhada</label>
							<label><input type="radio" name="guarda"<?php if($form["guarda_filho"] == "Sem filhos menores"){?> checked="checked"<?php }?> value="Sem filhos menores"> Sem filhos menores</label>
						...
						<li class="column column-large last fl-right">
							...
							<button id="enviaFormJudicial" class="btn btn-register">Enviar Cadastro</button>
						</li>
