	...
	<main>
			...
			<div class="content">
				<menu>
					<ul class="main-breadcrumb">
						<li><a href="">home</a></li>
						<li><a class="active" href="">formulário consensual em cartório (extrajudicial)</a></li>
					</ul>
				</menu>
			</div>
		...
		<section class="main-single container">
			...
			<div class="content">
				...
				<form name="" action="" method="POST">
					<ul class="info-form main-form">
						...
						<li class="column column-large last">
							<p class="obs-form">obs: Não é permitido realizar o divórcio em cartório quando o casal possuir filhos menores, sugerimos escolher a opção de <a href="form-consensual-judicial.html"><strong>Divórcio Consensual Judicial</strong></a>.</p>
						</li>
					</ul>
				</form>
				...
				<form class="main-form" action="" name="" method="POST">
					...
					<ul>
						...
						<li class="column column-large last">
							...
							<input type="tel"  name="telefone" placeholder="Digite seu endereço...">
						</li>
						...
						<li class="column column-large last">
							...
							<div class="column column-large">
								<label>RG</label>
								<input type="tel"  name="rg" placeholder="000.000.00-0">
							</div>

							<div class="column column-large last">

								<label>CPF</label>
								<input class="cpf-mask" type="tel"  name="cpf" placeholder="000.000.00-00">
							</div>
						...
						<li class="column column-large">
							...
							<input type="radio" value="" name="">Vai retornar o nome de solteiro?
							<input type="radio" value="" name="">Será mantido o nome de casado?
						</li>
						...
						<li class="column column-large last">
							...
							<input class="form-insert" type="text" value="" name="">
						</li>
				...
				<h3>2° Requerente (Cônjuge)</h3>
					...
					<ul>
						...
						<li class="column column-large">
							...
							<label><input type="radio" value="" name="nome_casado"> Vai retornar o nome de solteiro?</label>
							<label><input type="radio" value="" name="nome_casado"> Será mantido o nome de casado?</label>
						</li>
					...
					<ul>
						...
						<li class="column column-one">
							...
							<div class="column column-medium">
								<input type="tel" maxlength="2" name="" placeholder="00">
							</div>
							...
							<div class="column column-medium last">
								<input type="tel" maxlength="4" name="" placeholder="0000">
							</div>
						...
						<li class="column column-three">
							...
							<textarea placeholder="Descreva..." name="" rows="3"></textarea>
						</li>
						...
						<li class="form-register column column-large last">

							<div class="column column-large">
								<label class="call-register">Cadastre seu login de acesso ao sistema</label>
							</div>

							<div class="column column-large last">
								<label class="call-safety">Seus dados serão cadastrados em um servidor seguro e suas  informações serão mantidas em total sigilo e segurança.</label>
							</div>
							...
							<div class="column column-large last">
								...
								<div class="column column-large">
									<label>Senha</label>
									<input type="password" name="" placeholder="Digite uma senha...">
								</div>
							...
							<button class="btn btn-register">Enviar Cadastro</button>
